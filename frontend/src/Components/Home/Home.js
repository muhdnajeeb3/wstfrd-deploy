...
import exeedatwork from "../../images/home/exeed at work3.svg";
...
import { InstituteData, PartnerUniversitiesData, businessPartnersData, clientsData } from "../Homestaticdata";
...
function Home() {
    ...
    useEffect(() => {
        ...
        // setLengthPartners(businessPartnersData.length);
        //         const datas = businessPartnersData.slice(0, limit);
        //         setBusinesPartners(datas);
    }, [limit]);
    ...
    useEffect(() => {
        ...
        // setOwnuniversities(PartnerUniversitiesData)
    }, []);
    useEffect(() => {
        (async function () {
            try {
        ...
        //         const datas = clientsData.slice(0, clinetLimit);

        // setLengthClientes(clientsData);
        //         setCorporateClinets(datas);
    }, [clinetLimit]);
    const addLimit = () => {
        setLimit(limit + 5);
        ...
        <p>40%</p>
            ...
            <section class="corp-training" style={{ background: `url(${corp})`, height: "fit-content" }}>
                <div class="overlay" style={{ height: "fit-content", padding: "1rem 0" }}>
                    ...
                    <img src="https://westfordforbusiness.com/wp-content/uploads/2022/11/westford-business-logo.png" alt="" />
                    <img src={exeedatwork} alt="" style={{maxWidth:"157px"}}/>
                    </div>
                    {/* <button
                        onClick={() => {
                            navigate("/about");
